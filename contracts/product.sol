...
contract Product {
        ...
        )
    {
        ...
        uint256[] memory pids = new uint256[](productSNs.length);
        bytes32[] memory pSNs = new bytes32[](productSNs.length);
        bytes32[] memory pnames = new bytes32[](productSNs.length);
        bytes32[] memory pbrands = new bytes32[](productSNs.length);
        uint256[] memory pprices = new uint256[](productSNs.length);
        bytes32[] memory pstatus = new bytes32[](productSNs.length);
